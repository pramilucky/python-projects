...
class train:
  def __init__(self,name = '',num =0,arr_time = '',dep_time = '',src = '',des = '',day_of_travel = '',seat_avaliable_in_1AC=0,seat_avaliable_in_2AC=0,seat_avaliable_in_SL=0, fare_1ac=0,fare_2ac=0,fare_sl=0):
        self.name = name
        self.num = num
        ...
        self.seats = {'1AC':seat_avaliable_in_1AC,'2AC':seat_avaliable_in_2AC,'SL':seat_avaliable_in_SL}
...
class acceptors:
    ...
    accepting and validating values properly  '''
    def accept_uid():
        uid = 0
        try:
...
t2 =train('howrah',12565,'02:34','23:12','hwr','kol','mon',34,4,12,3434,435,234)
t3 =train('bangalore',22353,'11:56','03:12','ctc','ban','fri',33,24,77,455,325,533)
trains={t1.num:t1,t2.num:t2,t3.num:t3}
u1=user(1111,'prami','cuttack','7478021777','prami')
u2=user(2322,'alex parrish','new york','7873752967','alex parrish')
